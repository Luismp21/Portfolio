...
export const Footer = () => {
  ...
  return (
    <section className="container mx-auto w-1/2">
      <div className="flex justify-between mb-10"  data-aos="fade-up"
      ...
      <div className="flex flex-col items-center border-indigo-600 border-t-2 py-4">
        <div className="flex items-center justify-center gap-6 ">
          <p className="font-semibold dark:font-normal dark:text-slate-400">{t("footer.footer.p1")}</p>
          <img src="./public/react.svg" width={"40px"} />
          <img src="./public/tailwind.svg" width={"40px"} />
        </div>
        <p className="font-semibold dark:font-normal dark:text-slate-400">{t("footer.footer.p2")}</p>
      </div>
    </section>
  );
};
